...
# Register time entries endpoints
api_router.include_router(
    time_entries.router,
    tags=["time-entries"]
)
...
# Register employees endpoints (old endpoint for linking employees to users)
api_router.include_router(
    employees.router,
    prefix="/employees",
    tags=["employees"]
...
# Register employes endpoints (new CRUD endpoints for employees)
api_router.include_router(
    employes_router,
    tags=["employes"]
)

# Register custom widgets endpoints
api_router.include_router(
    custom_widgets.router,
    tags=["custom-widgets"]
)

# Register Leo settings endpoints
api_router.include_router(
    leo_settings.router,
    prefix="/leo",
    tags=["leo"]
