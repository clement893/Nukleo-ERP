...
import { People, PeopleCreate, PeopleUpdate } from '@/lib/api/people';
...
interface PeopleFormProps {
  person?: People | null;
  onSubmit: (data: PeopleCreate | PeopleUpdate) => Promise<void>;
  onCancel: () => void;
  loading?: boolean;
}
...
export default function PeopleForm({
  ...
  const [formData, setFormData] = useState<PeopleCreate>({
    ...
    portal_url: person?.portal_url || null,
