 ...
 * 
 * Third-party integrations and connections management.
 * 
 * @component
 */
 ...
 * Integrations Settings Component
 * 
 * Displays list of available integrations with toggle functionality.
 */
export default function IntegrationsSettings({ 
  ...
  const displayIntegrations = localIntegrations.length > 0 ? localIntegrations : defaultIntegrations;
  ...
  const groupedIntegrations = displayIntegrations.reduce((acc, integration) => {
