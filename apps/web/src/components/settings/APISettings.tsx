 ...
 * API Settings Component
 * 
 * Displays form for API configuration and settings.
 */
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData({ ...formData, rateLimit: parseInt(e.target.value) || 1000 })}
                min={1}
                max={10000}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData({ ...formData, enableWebhooks: e.target.checked })}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData({ ...formData, enableLogging: e.target.checked })}
              />
            </div>
          </div>
        </Card>
