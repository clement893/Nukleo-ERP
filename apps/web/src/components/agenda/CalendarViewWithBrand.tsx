        ...
        <div className="mt-6 pt-6 border-t border-[#A7A2CF]/20">
          ...
          <div className="flex flex-wrap gap-4 text-sm">
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-700 dark:text-gray-300">Jours fériés</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-4 h-4 rounded-md border border-gray-300 dark:border-gray-600" style={{ backgroundColor: '#F59E0B' }} />
              <span className="text-gray-700 dark:text-gray-300">Vacances d'été</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-4 h-4 rounded-md border border-gray-300 dark:border-gray-600" style={{ backgroundColor: '#10B981' }} />
              <span className="text-gray-700 dark:text-gray-300">Vacances approuvées</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-4 h-4 rounded-md border border-gray-300 dark:border-gray-600" style={{ backgroundColor: '#3B82F6' }} />
              <span className="text-gray-700 dark:text-gray-300">Deadlines / Événements</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-4 h-4 rounded-md border border-gray-300 dark:border-gray-600" style={{ backgroundColor: '#F59E0B' }} />
              <span className="text-gray-700 dark:text-gray-300">Vacances en attente</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-4 h-4 rounded-md border border-gray-300 dark:border-gray-600" style={{ backgroundColor: '#EC4899' }} />
              <span className="text-gray-700 dark:text-gray-300">Anniversaires</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-4 h-4 rounded-md border border-gray-300 dark:border-gray-600" style={{ backgroundColor: '#06B6D4' }} />
              <span className="text-gray-700 dark:text-gray-300">Dates d'embauche</span>
            </div>
          </div>
        </div>
      </div>
