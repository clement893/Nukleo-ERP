/**
 * CompanyNotesEditor Component
 * 
 * Composant pour éditer les notes d'une entreprise directement dans l'onglet,
...
export interface CompanyNotesEditorProps {
  companyId: number;
      ...
      {!notes && !hasChanges && (
        <Card className="glass-card p-6">
          <div className="text-center py-8 text-muted-foreground">
            <p className="mb-2">Aucune note pour cette entreprise.</p>
