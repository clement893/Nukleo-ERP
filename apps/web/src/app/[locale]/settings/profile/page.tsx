 ...
 * 
 * User account settings and preferences page accessible from settings.
...
export default function ProfileSettingsPage() {
  ...
  if (!user) {
    return (
      <ProtectedRoute>
        <PageContainer>
          <PageHeader title={t('title') || 'Profile Settings'} description={t('description') || 'Manage your account settings'} />
  ...
  return (
    <ProtectedRoute>
      <PageContainer>
        <PageHeader
          title={t('title') || 'Profile Settings'}
