 ...
 * 
 * Page for managing blog posts/articles with CRUD operations in the admin panel.
 */
...
export default function AdminArticlesManagementPage() {
  ...
  return (
    <ProtectedRoute requireAdmin>
      <PageContainer>
        <PageHeader
          title={t('title') || 'Articles Management'}
          description={t('description') || 'Create and manage your blog posts and articles'}
          breadcrumbs={[
