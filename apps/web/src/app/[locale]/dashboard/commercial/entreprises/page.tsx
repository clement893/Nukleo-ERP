...
import { Plus, Edit, Trash2, Eye, List, Grid, Download, Upload, MoreVertical, Filter, X, Building2, FileSpreadsheet } from 'lucide-react';
                    ...
                    <>
                      ...
                      <div className="absolute right-0 mt-1 w-48 bg-background border border-border rounded-md shadow-lg z-20">
                        <div className="py-1">
                          ...
                          >
                            <FileSpreadsheet className="w-3.5 h-3.5" />
                            Télécharger modèle ZIP (avec logos)
                          </button>
                        </div>
                      </div>
                    </>
