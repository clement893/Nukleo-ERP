...
export default function ContactEditPage() {
  ...
  const handleUpdate = async (data: ContactCreate | ContactUpdate) => {
    ...
    try {
      ...
      router.push(`/${locale}/dashboard/commercial/contacts/${contactId}`);
    } catch (err) {
      const appError = handleApiError(err);
      ...
      <PageContainer>
        <PageHeader
          ...
          breadcrumbs={[
            ...
            { label: 'Contacts', href: `/${locale}/dashboard/commercial/contacts` },
            { label: 'Modification' },
          ]}
        />
    ...
    <PageContainer>
      <PageHeader
        ...
        breadcrumbs={[
          ...
          { label: 'Module Commercial', href: `/${locale}/dashboard/commercial` },
          { label: 'Contacts', href: `/${locale}/dashboard/commercial/contacts` },
          { label: contact.first_name + ' ' + contact.last_name, href: `/${locale}/dashboard/commercial/contacts/${contact.id}` },
          { label: 'Modification' },
        ]}
      />
