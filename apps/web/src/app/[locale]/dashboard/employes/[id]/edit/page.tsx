...
export default function EmployeeEditPage() {
  ...
  const handleUpdate = async (data: EmployeeCreate | EmployeeUpdate) => {
    ...
    try {
      ...
      router.push(`/${locale}/dashboard/employes/${employeeId}`);
    } catch (err) {
      const appError = handleApiError(err);
  ...
  const handleCancel = () => {
    if (employeeId) {
      ...
      router.push(`/${locale}/dashboard/employes`);
    }
  };
      ...
      <PageContainer>
        <PageHeader
          ...
          breadcrumbs={[
            ...
            { label: 'Employés', href: `/${locale}/dashboard/employes` },
            { label: 'Modification' },
          ]}
        />
    ...
    <PageContainer>
      <PageHeader
        ...
        breadcrumbs={[
          { label: 'Dashboard', href: `/${locale}/dashboard` },
          { label: 'Employés', href: `/${locale}/dashboard/employes` },
          { label: employee.first_name + ' ' + employee.last_name, href: `/${locale}/dashboard/employes/${employee.id}` },
          { label: 'Modification' },
        ]}
      />
