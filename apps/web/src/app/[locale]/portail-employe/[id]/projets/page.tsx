...
import EmployeePortalProjects from '@/components/employes/EmployeePortalProjects';
import { useAuthStore } from '@/lib/store';
import { checkMySuperAdminStatus } from '@/lib/api/admin';

export default function EmployeePortalProjectsPage() {
  ...
  return (
    <div className="w-full px-4 sm:px-6 lg:px-8 py-8">
      <PageHeader
        title={`Mes projets - ${employee.first_name} ${employee.last_name}`}
        description="Gérez tous vos projets"
        actions={
